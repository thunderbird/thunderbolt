...
const DropdownMenuSubTrigger = ({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        'focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground flex cursor-default items-center rounded-md px-[var(--spacing-x-sm)] py-[var(--spacing-y-md)] text-[length:var(--font-size-body)] outline-hidden select-none data-[inset]:pl-9 md:data-[inset]:pl-8',
        className,
      )}
      {...props}
    >
