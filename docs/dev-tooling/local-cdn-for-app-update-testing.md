...
- Tauri v2 requires exactly those variable names; real releases pass the same two (`.github/workflows/desktop-release.yml`, [Tauri Signing Keys](../features/tauri-signing-keys.md)).
