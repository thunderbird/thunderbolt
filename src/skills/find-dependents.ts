 ...
 * skill's name as a slash-token (matches at a word boundary — followed by
 * whitespace or end-of-line). Matches the same rule the slash autocomplete
 * uses so what the user *sees* as a reference is what we *count* as a
 * dependency.
 */
