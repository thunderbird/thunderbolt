...
const inputVariants = cva(
  'border-input file:text-foreground placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground flex min-w-0 rounded-md border bg-transparent px-3 py-1 text-[length:var(--font-size-body)] outline-none file:inline-flex file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      variant: {
      ...
      inputSize: {
        ...
        sm: 'h-[var(--touch-height-sm)] text-xs px-2 py-1 rounded-md',
        lg: 'h-[var(--touch-height-lg)] text-base px-4 py-2 rounded-md',
        xl: 'h-[var(--touch-height-xl)] text-lg px-6 py-1.5 rounded-lg',
      },
      state: {
        default: '',
