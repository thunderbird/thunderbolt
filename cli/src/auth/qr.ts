 ...
 * wide enough to hold one. Both this fallback decision and the real renderer
...
/**
 * Render a compact QR of `text` as a string. Callers gate this behind
 ...
 */
export const renderTerminalQr = (text: string): string => {
  let output = ''
