 ...
 * values (null, numbers, …) are skipped explicitly. With the v1 `__enc:`
 * prefix idempotency net gone (THU-429), encode running exactly once per CRUD
 * op is the invariant; it is structurally guaranteed because `codec.encode`
 * is called solely from here, once per configured column.
 */
