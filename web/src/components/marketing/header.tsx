...
export const Header = ({ action }: HeaderProps) => (
  <header className="fixed inset-x-0 top-0 z-50 bg-white/20 backdrop-blur-[32px]">
    <div className="mx-auto flex h-[104px] max-w-[1440px] items-center justify-between px-6 lg:px-[160px]">
