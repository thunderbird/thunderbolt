...
export const TARGET_URL_HEADER = 'X-Proxy-Target-Url'

/** Caller header opting in/out of redirect following (`true` | `false`). */
export const FOLLOW_REDIRECTS_HEADER = 'X-Proxy-Follow-Redirects'

/** Response header echoing the final hop URL after redirect following. */
export const FINAL_URL_HEADER = 'X-Proxy-Final-Url'
 ...
 *  casing in `PASSTHROUGH_PREFIX_CASED`. */
export const PASSTHROUGH_PREFIX = 'x-proxy-passthrough-'
export const PASSTHROUGH_PREFIX_CASED = 'X-Proxy-Passthrough-'

/** WS subprotocol marker that carries the base64url-encoded target URL. */
export const WS_TARGET_PREFIX = 'tbproxy.target.'
...
export const PROXY_FRAMING_HEADERS = new Set(['content-security-policy', 'content-disposition'])
