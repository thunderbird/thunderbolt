...
export type DeviceGrantFailure = { reason: 'expired' | 'invalid'; message: string }
 ...
 * into a typed failure. Only `expired_token` is distinguished; everything else is an
 * invalid/used code from the user's perspective.
 */
