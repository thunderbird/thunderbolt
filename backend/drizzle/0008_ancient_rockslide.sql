...
--> statement-breakpoint
ALTER TABLE "powersync"."devices" ADD COLUMN "status" text DEFAULT 'TRUSTED' NOT NULL;--> statement-breakpoint
...
UPDATE "powersync"."devices" SET "status" = 'REVOKED' WHERE "revoked_at" IS NOT NULL;