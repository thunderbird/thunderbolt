...
describe('Authentication Routes', () => {
  ...
  beforeAll(async () => {
    ...
    getSettingsSpy = spyOn(settingsModule, 'getSettings').mockReturnValue({
      ...
      googleClientIdAndroid: 'test-google-android-client-id',
      googleClientIdIos: 'test-google-ios-client-id',
      microsoftClientId: 'test-microsoft-client-id',
      microsoftClientSecret: 'test-microsoft-secret',
      microsoftClientIdAndroid: 'test-microsoft-android-client-id',
      microsoftClientIdIos: 'test-microsoft-ios-client-id',
      logLevel: 'INFO',
      port: 8000,
