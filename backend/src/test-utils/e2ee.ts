...
/**
 * Test helpers for E2EE v2 challenge-response: generate a P-256 keypair, export
 * the public key the way clients upload it (base64 SPKI), and sign challenge
 * payloads through the SHARED encoder so tests exercise the exact byte layout
