...
- mode: "single" (one designated answer), "multiple" (one or more designated answers), "choice" (no designated answer, the user picks one — e.g. "What do you want to do next?"), or "choices" (no designated answer, the user picks one or more — a preference/opinion question, e.g. "Which of these do you like?")
- prompt: the question or prompt text
- options: a JSON array wrapped in SINGLE quotes. Each option is {"id":"a","text":"..."}; for modes with a designated answer add "isCorrect":true to the intended option(s). Never set isCorrect in "choice" or "choices" mode.
...
Example (choices): <widget:ask mode="choices" prompt="Which of these do you like?" options='[{"id":"a","text":"Coffee"},{"id":"b","text":"Tea"},{"id":"c","text":"Neither"}]' />`
