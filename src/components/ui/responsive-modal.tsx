          ...
          <DialogPrimitive.Content
            ...
            className={cn(
              ...
              isMobile
                ...
                : 'top-[50%] left-[50%] w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] overflow-hidden rounded-xl border sm:max-w-md shadow-lg min-h-[550px] max-h-[85vh] flex flex-col',
              className,
            )}
            style={
              isMobile
      ...
      <DialogPrimitive.Content
        className={cn(
          ...
          isMobile
            ...
            : 'top-[50%] left-[50%] w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] overflow-hidden rounded-xl border sm:max-w-lg shadow-lg',
          className,
        )}
        style={
          isMobile
