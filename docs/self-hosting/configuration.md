...
| `TINFOIL_CLIENT_ID`       | —                          |          | Tinfoil OAuth client ID — public PKCE client (no secret); lets users link their Tinfoil subscription for direct attested-enclave inference |
