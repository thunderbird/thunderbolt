...
import { Menu, MoreHorizontal, Play, Plus, Search, SquarePen, Trash2 } from 'lucide-react'
...
export const SkillsList = ({
  ...
  const visibleSkills = useMemo(() => {
    ...
    // Disabled rows sink to the bottom of the list so the actionable items
    // stay near the top regardless of the alphabetical primary sort.
