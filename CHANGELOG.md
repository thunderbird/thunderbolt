...
### Fixes
- Stop MCP tool discovery failures from blocking chat sends (#1277) (51c276c)

## [0.1.132] - 2026-09-10

### Other
- Pass the build version into the Android package.json rewrite (#1276) (d612a63)

## [0.1.131] - 2026-09-10

### Features
- Bump GLM models (#1269) (8f7f546)

## [0.1.130] - 2026-09-10

### Fixes
- Sync CLI version in nightly releases (#1273) (57f127e)
- Stop button not working properly (#1230) (99b406d)

### Other
- Cover the language picker with e2e and unit tests (#1274) (935de4e)
- Isolate the config store and indexedDB stub between test files (#1270) (d3480a2)

## [0.1.129] - 2026-09-05

### Fixes
- Restore model startup on older mobile webviews (#1268) (2c1e857)

## [0.1.128] - 2026-09-05

### Features
- Serve DeepSeek V4 Flash as a confidential model (#1264) (913171e)
- Run the app's Tinfoil models on the Pi harness (#1263) (e7b2cb3)
- Account-backed CLI with provider profiles and CLI device management (#1258) (dbdc545)
- Localize place names and search in the user's language (#1253) (17ab630)
- Forward the user's language to link previews (#1254) (b74b1d2)
- Localize transactional email and let users pick a language (#1255) (bd00644)

### Fixes
- Preserve research state at the web budget limit (#1265) (2e61366)
- Cut chat titles on word boundaries (#1252) (0a8d5fc)

### Performance
- Smooth streamed chat text and reasoning (#1266) (505f34d)

### Refactor
- Extract the confidential Pi model core into shared/agent-core (#1262) (0633fcb)
- Share one OpenAI-compatible Pi model builder between the app and the CLI (#1261) (d07e36c)

### Other
- Reply in the conversation's language — prompt directive + eval suite (#1245) (905aedf)
...
### Other
- Name release binaries thunderbolt-cli-<target> (#1081) (55eb43a)
