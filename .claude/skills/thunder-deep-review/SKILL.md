...
- `docs/architecture/e2ee-threat-model.md` — the single source of truth. Its adversaries (A1–A10), claims (C1–C15), v1 regressions, and "Known and accepted" list are the review frame. Findings MUST name the C-id/A-id they bear on (e.g. "C2 under A2"). The claim list grows — read the file rather than trusting this range.
